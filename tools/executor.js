...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      outOfRangeLeftWaitMinutes: ["management", "outOfRangeLeftWaitMinutes"],
      closeLeftOorOnlyAtProfit: ["management", "closeLeftOorOnlyAtProfit"],
      ...
      tpLadderEnabled: ["management", "tpLadderEnabled"],
      tpLadderLevels: ["management", "tpLadderLevels"],
