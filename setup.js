...
const PRESETS = {
  ...
  // ── Community presets (source: @0xyunss, Jun 2026) ──────────────────────────
  // "casual" = volume-spike / runner play, 2-6h holds, fast cycles (the 9-5 grind).
  casual: {
    label:                 "Casual",
    strategy:              "bid_ask",
    timeframe:             "30m",
    ...
    minMcap:               250_000,
    maxMcap:               5_000_000,
    minTvl:                5_000,        // active TVL floor
    maxTvl:                100_000,
    minVolume:             2_000,
    minBinStep:            80,
    maxBinStep:            125,
    minFeeActiveTvlRatio:  0.3,          // fee/aTVL 0.3%
    minTokenFeesSol:       20,
    takeProfitPct:         10,
    stopLossPct:           -25,
    outOfRangeWaitMinutes: 15,
    ...
    managementIntervalMin: 5,
    screeningIntervalMin:  15,
    description: "30m volume-spike runners, 2-6h holds, fast cycles (@0xyunss casual play).",
  },
  // "multiday" = hold 24h+, target ~20% fees from position. Pick top 1-4 pools.
  multiday: {
    label:                 "Multiday",
    strategy:              "spot",
    timeframe:             "24h",
    ...
    minFeeActiveTvlRatio:  0.4,
    minTokenFeesSol:       30,
    takeProfitPct:         20,           // target ~20% fees from position
    stopLossPct:           -15,
    outOfRangeWaitMinutes: 60,
    trailingTakeProfit:    true,
    trailingTriggerPct:    5,
    ...
    managementIntervalMin: 15,
    screeningIntervalMin:  60,
    description: "24h+ holds on $1M+ pools, target ~20% fees, top 1-4 picks (@0xyunss multiday play).",
  },
};
...
const presetChoice = await askChoice("Select a risk preset:", [
  ...
  { label: `⚡ Casual   — ${PRESETS.casual.description}`,    key: "casual"   },
  { label: `📅 Multiday — ${PRESETS.multiday.description}`,  key: "multiday" },
